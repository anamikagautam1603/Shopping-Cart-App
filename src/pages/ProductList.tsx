...
export function Store() {
    return (
        <><section className="min-h-screen py-12 bg-gray-50 dark:bg-gray-900 flex flex-col items-center">
            ...
            <div className="mt-12">
                <Link to="/">
                    <button className="px-6 py-3 text-lg font-semibold text-gray-700 dark:text-white bg-gray-200 dark:bg-gray-700 rounded-full shadow-md hover:bg-gray-300 dark:hover:bg-gray-600 transition-all">
                        ⬅ Back to Home
                    </button>
                </Link>
            </div>
